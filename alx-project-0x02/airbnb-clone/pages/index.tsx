...
export default function Home() {
  return (
    <div
      className={`${geistSans.className} ${geistMono.className} font-sans grid grid-rows-[auto_1fr_auto] min-h-screen`}
    >
      {/* Header */}
      <Header />

      {/* Main Content */}
      <main className="flex flex-col items-center row-start-2 gap-8 p-8 sm:items-start sm:p-20">
        ...
        <ol className="font-mono text-sm text-center list-decimal list-inside sm:text-left">
      ...
      {/* Footer */}
      <footer className="flex flex-wrap items-center justify-center row-start-3 gap-6 p-4">
        <a
